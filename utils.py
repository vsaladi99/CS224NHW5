...
def pad_sents_char(sents, char_pad_token):
    ...
    sents_padded = []
    for sent in sents:
        padded_sent = [[char_pad_token]*max_word_length]*max_sent_length
        pad_word = []
        for word in sent:
            pad_w = [char_pad_token]*max_word_length
            if len(word) <= max_word_length:
                pad_w[:len(word)] = word[:len(word)]
            else:
                pad_w[:max_word_length] = word[:max_word_length]
            pad_word.append(pad_w)

        padded_sent[:len(pad_word)] = pad_word
